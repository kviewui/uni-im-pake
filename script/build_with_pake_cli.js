...
let params = `node cli.js ${process.env.URL} --name ${process.env.NAME} --height ${process.env.HEIGHT} --width ${process.env.WIDTH} --inject ../../src-tauri/style/uni-im.css --debug`;
